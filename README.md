...
## Project Structure
quantum-trading-thermal-stability/ ├── LICENSE                              # Creative Commons Attribution 4.0 License ├── Quantum_Trading_Thermal_Stability.pdf # Compiled 100% vectorial PDF ├── README.md                            # Project documentation ├── cmb_results.tex                      # CMB results table ├── counts.dat                           # Data for QRL counts histogram ├── main.tex                             # Main LaTeX document ├── p_error.dat                          # Data for fidelity vs. ΔT plot ├── qrl_cmb_simulation.py                # Python script for simulation └── references.bib                       # IEEE-style references
## Requirements
